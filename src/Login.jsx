      ...
      <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '40px 32px', width: '100%', maxWidth: 380, textAlign: 'center' }}>
        ...
        {role === 'student' && (
          <div style={{ marginTop: 14, fontSize: 12, color: 'var(--text3)', fontFamily: 'var(--mono)' }}>
            Template PIN: <strong style={{ color: 'var(--text2)' }}>1611</strong>
          </div>
        )}

        <div style={{ marginTop: 14, fontSize: 12, color: 'var(--text3)', lineHeight: 1.6 }}>Contact ICT-Research Engineers for<br />registration or login issues</div>
